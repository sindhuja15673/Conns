...
//         </div>
//         <div className='telimg'>
//           <div><img src={tele1} alt="80+"></img><h5>80+</h5></div>
//           <div><img src={tele2} alt="70 to 79"></img><h5>70" to 79"</h5></div>
//           <div><img src={tele3} alt="60 to 69"></img><h5>60" to 69"</h5></div>
//           <div><img src={tele4} alt="50 to 59"></img><h5>50" to 59"</h5></div>
//         </div>
//         <div className='telecart'>
//           {products.map((product, index) => (
//             <div key={index} className='teleimg'>
